...
def test_search_movies(test_app):
    ...
    temp_movie1 = movie_rep.create_movie('Avengers', 'Russo Brothers', 5)
    temp_movie2 = movie_rep.create_movie('Spider-Man', 'Jon Watts', 3)
    ...
    assert temp_movie1.director in response.data.decode('utf-8')
